...
namespace aoc2023.Day09
{
    ...
    // part 1
    //
    public class Day09Part1Code : MonoBehaviour
    {
        private enum Input
        {
            Example1,
        ...
        private async void Start()
        {
            ...
            {
                Input.Example1 => "day09/example1_in.txt",
                Input.Puzzle1 => "day09/puzzle1_in.txt",
                _ => "NOT_SET"
            };
        ...
        private long ExtrapolateNextValue(IReadOnlyList<long> values)
        {
            ...
            for (var i = 0; i < n; i++)
            {
                ...
                nextValue += sign * values[n - i - 1] * _pascalTriangle[n][i + 1];
                sign = -sign;
            }
